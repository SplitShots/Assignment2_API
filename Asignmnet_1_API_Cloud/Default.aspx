        ...
        <form id="orderForm" runat="server">
            ...
            <asp:Table ID="Table1" runat="server">
                <asp:TableHeaderRow runat="server">
                    ...
                    <%--<input type="text" name="lName" form="orderForm" class="auto-style6" /></td>--%><%--<td class="auto-style4">&nbsp;</td>--%></asp:TableHeaderRow><%--<tr>
                    <td>
                    ...
                    <td class="auto-style3">--%><%--  <asp:TextBox ID="TextBox1" Style="resize: none" Width="150px" Height="30px" Wrap="true" runat="server" />--%><%--<input type="text" name="city" form="orderForm" class="auto-style6" /></td>--%><asp:TableHeaderRow runat="server"> 
                        <asp:TableHeaderCell>
                            ...
                            <asp:TextBox type="text" id="postalCode"  form="orderForm" class="auto-style6" runat="server" /></asp:TableHeaderCell></asp:TableHeaderRow><%--<td class="auto-style4">&nbsp;</td>--%><%--</tr>--%>
                <asp:TableHeaderRow runat="server">
                    <asp:TableHeaderCell>
                        <p class="auto-style2">Phone Number:</p>
                   </asp:TableHeaderCell><asp:TableHeaderCell>
                        <asp:TextBox type="text" id="phoneNumber" form="orderForm" class="auto-style6" runat="server" /></asp:TableHeaderCell><asp:TableHeaderCell>
                     ...
                     </asp:TableHeaderCell></asp:TableHeaderRow><asp:TableHeaderRow runat="server">
                     <asp:TableHeaderCell>
                     ...
                     </asp:TableHeaderCell><asp:TableHeaderCell>&nbsp;</asp:TableHeaderCell></asp:TableHeaderRow><asp:TableHeaderRow runat="server">
                     <asp:TableHeaderCell>
                    ...
                    </asp:TableHeaderCell></asp:TableHeaderRow></asp:Table></form></div></body></html>